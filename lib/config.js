 ...
 * @property {(args = { currentOpt: HTMLElement, selected: Array<HTMLElement> })} [onSelection] The function to call when an option is selected. If the callback returns false or throws an error, the selection will be prevented and the option will remain unselected.
 * @property {(args = { currentOpt: HTMLElement, selected: Array<HTMLElement> })} [onDeselection] The function to call when an option is deselected. If the callback returns false or throws an error, the deselection will be prevented and the option will remain selected.
 * @property {(selected: HTMLDivElement[]) => string} [selectionValue] The function to get & set the value of the selected options
