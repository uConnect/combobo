  ...
  _createClass(Combobo, [{
    ...
    value: function initEvents() {
      ...
      if (!this.optionsWithKeyEventHandlers.has(this.input)) {
        this.input.addEventListener('click', function () {
          _this2.openList().goTo(_this2.getOptIndex() || 0); // ensure it's open
        });
        ...
        if (this.toggleButton) {
          ...
          this.toggleButton.addEventListener('click', function (e) {
            ...
            if (_this2.isOpen) {
              ...
              _this2.openList().input.focus();
            }
          });

          // Add mouse handlers so the blur on the input doesn't close the list prematurely
          this.toggleButton.addEventListener('mouseover', function () {
            _this2.isHovering = true;
          });
          this.toggleButton.addEventListener('mouseout', function () {
    ...
    value: function initKeys() {
      ...
      _keyvent2.default.down(this.input, [{
        ...
        callback: function callback(e, k) {
          if (_this5.isOpen) {
            ...
            if (_this5.currentOpts.indexOf(_this5.currentOption) === -1) {
              return _this5.goTo(0, true);
            }
            return _this5.goTo(k === 'down' ? 'next' : 'prev', true);
          }

          var idx = _this5.selected.length ? _this5.currentOpts.indexOf(_this5.selected[_this5.selected.length - 1]) : 0;

          _this5.goTo(idx, true).openList();
        },
        preventDefault: true
      }, {
        keys: ['enter'],
        ...
        callback: function callback(e) {
          if (_this5.isOpen) {
            e.stopPropagation();
            _this5.closeList(true, true);
          }
        }
      }, {
        keys: ['backspace'],
        callback: function callback() {
          if (_this5.selected.length >= 2) {
            _this5.input.value = '';
          }
        }
      }]);
      ...
      _keyvent2.default.down(window, function (e) {
        ...
        if (key === ' ' && e.target === _this5.input) {
          if (_this5.config.selectOnly) {
            e.preventDefault();
            e.stopPropagation();
          }
          if (!_this5.isOpen) {
      ...
      _keyvent2.default.down(this.input, function (e) {
        ...
        if (key && [' ', 'tab', 'backspace'].includes(key.toLowerCase()) && _this5.isOpen) {
          // Don't close (+select) the list if the user is typing in the input
          if (!_this5.config.selectOnly && key.toLowerCase() === 'backspace') {
            return;
          }
      ...
      if (this.config.selectOnly) {
        ...
        */
        function (e) {
          ...
          var searchString = _this5.getSearchString(key);

          if (!_this5.isOpen) {
            _this5.openList();
          }

          var searchIndex = _this5.searchIndex(searchString);
          if (searchIndex > -1) {
            _this5.goTo(searchIndex);
          }
        });
        ...
        this.input.addEventListener('blur', function () {
          ...
          if (_this5.selected.length) {
            _this5.input.innerText = _this5.config.selectionValue(_this5.selected);
          }
        });
      }
      ...
      _keyvent2.default.up(this.input, function (e) {
        ...
        if (!_this5.autoFilter) {
          return;
        }
        var filter = _this5.config.filter;
        var cachedVal = _this5.cachedInputValue;
        if (ignores.indexOf(e.which) > -1 || !filter || _this5.input.tagName.toLowerCase() === 'div') {
          return;
        }

        // Handles if there is a fresh selection
        if (_this5.freshSelection) {
          _this5.clearFilters();
          if (cachedVal && cachedVal.trim() !== _this5.input.value.trim()) {
            // if the value has changed...
            _this5.filter().openList();
            _this5.freshSelection = false;
          }
        } else {
          _this5.filter().openList();
        }
        ...
        (0, _noResults2.default)(_this5.list, _this5.currentOpts, _this5.config.noResultsText);
      });
    }
    ...
    value: function filter(suppress, value) {
      ...
      if (!befores.every(function (b) {
        return _this6.currentOpts.indexOf(b) > -1;
      }) && !suppress) {
        this.announceCount();
      }
    ...
    value: function updateOpts() {
      ...
      this.cachedOpts.forEach(function (opt) {
        ...
        opt.style.display = _this7.currentOpts.indexOf(opt) === -1 ? 'none' : '';
        // configure the innerHTML of each option
        opt.innerHTML = typeof optVal === 'string' ? (0, _wrapMatch2.default)(opt, _this7.input.tagName.toLowerCase() === 'div' ? _this7.getSearchString() : _this7.input.value, optVal) : optVal(opt);
      });
    ...
    value: function select() {
      ...
      this.cachedOpts.forEach(function (o) {
        o.setAttribute('aria-selected', _this8.selected.indexOf(o) > -1 ? 'true' : 'false');
      });
    ...
    value: function reset() {
      ...
      this.cachedOpts.forEach(function (optEl) {
        (0, _classlist2.default)(optEl).remove(_this9.config.selectedClass);
        (0, _classlist2.default)(optEl).remove(_this9.config.activeClass);
    ...
    value: function goTo(option, fromKey) {
      ...
      this.currentOpts.forEach(function (opt) {
        if (opt.classList.contains(_this10.config.activeClass) && !(0, _isScrolledInView2.default)(_this10.list, opt)) {
    ...
    value: function transformSelectElement(selectElement) {
      ...
      Array.from(selectElement.children).forEach(function (child) {
        ...
        if (origOptgroup) {
          ...
          optgroup.className = [_this12.config.optgroupClass, origOptgroupClass].filter(Boolean).join(' ');
          optgroup.setAttribute('role', 'group');
          var groupId = (0, _rndid2.default)();
          optgroup.setAttribute('aria-labelledby', groupId);

          var label = document.createElement('div');
          label.className = _this12.config.optgroupLabelClass;
          label.id = groupId;
          ...
          Array.from(child.children).forEach(function (option) {
            ...
            optgroup.appendChild(_this12.createOptionElement(data.text, data.value, data.selected, data.disabled, data.origClass));
          });
          ...
          listbox.appendChild(_this12.createOptionElement(data.text, data.value, data.selected, data.disabled, data.origClass));
        }
      });
    ...
    value: function createOptionElement(text, value, selected, disabled, origClass) {
